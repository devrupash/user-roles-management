...
Route::get('/secret', [RoleController::class, 'secretMessage'])->can('secret');
...
Route::get('/update-role-again', [RoleController::class, 'updateRoleAgain'])->middleware(['can:update,\App\Models\Role::class']);
Route::get('/update-single-role/{role}', [RoleController::class, 'updateSingleRole'])->middleware(['can:update,role']);